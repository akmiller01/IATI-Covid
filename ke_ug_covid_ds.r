...
# dportal_activity_filter_vec = paste0('"',dportal_acts,'"')
# dportal_activity_filter = paste0(dportal_activity_filter_vec,collapse=" ")
# 
# activity_url = paste0(
#   "https://iati.cloud/search/activity?q=",
#   "iati_identifier: (",dportal_activity_filter,")",
#   "&fl=",
...
# 
# save(activities,transactions,file="ke_ug_covid2.RData")
load("ke_ug_covid2.RData")
...
fwrite(transactions,"ke_ug_covid2.csv")
